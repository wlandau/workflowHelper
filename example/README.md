...
- Ensure that [R](https://www.r-project.org/), the [`parallelRemake`](https://github.com/wlandau/parallelRemake/) package, the [`workflowHelper`](https://github.com/wlandau/workflowHelper) package, and [GNU make](https://www.gnu.org/software/make/) are installed.

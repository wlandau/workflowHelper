...
I keep the functions to generate data, analyze data, etc. in `code.R`, and I have a sketch of the whole workflow in `workflow.R`. You can generate both these files with the `write_example_workflowHelper` function. Typically, in your own workflows, you will write similar R scripts by hand.
